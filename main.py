...
async def addseats(payload: dict):
    ...
    user_email = "jgnsecrets@gmail.com"

    seat_count = len(selectedSeats)
    total_amount = seat_count * busFee + 32.25
    selected_seats = [str(seat) for seat in selectedSeats]

    send_booking_confirmation_email(user_email, busFromTime, busToTime, fromPlace,
                                    toPlace, busName, busFee, seat_count, total_amount, selected_seats)
